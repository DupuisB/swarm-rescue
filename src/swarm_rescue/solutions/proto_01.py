...
class MyTestDrone(DroneAbstract):
    def __init__(self, **kwargs):
        ...
        self.position_consigne = [0.0, 0.0]
    ...
    def relative_pos_to_abs(self, delta_lat, delta_vert):
        ...
        return (self.measured_gps_position()[0] + delta_x, self.measured_gps_position()[1] + delta_y)
    ...
    def control(self):
        ...
        if abs(estim_dist_a_droite - 50) > 5:  # va se coler au mur à sa droite
            print("faut droite")
